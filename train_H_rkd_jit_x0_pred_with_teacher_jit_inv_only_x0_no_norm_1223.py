...
WANDB_NAME=f"1223_lr1e4_n32_H_b{BATCH_SIZE}_T100_ddim_30_50_steps_teacher_init_rkdW{W_RKD}_invW{W_INV}_invinvW{W_INVINV}_fidW{W_FID}_sameW{W_SAME}_x0_pred_rkd_with_teacher_jit_no_norm"
