...
WANDB_NAME_LORA = f"1124_lora_student_n{N}_lr1e4_b{BATCH_SIZE}_T1000_rank2_alpha2"
...
CONFIG_LORA = {
    ...
    "student_data_stats": f"smile_data_n{N}_scale2_rot60_trans_50_-20/normalization_stats.json",
    "student_data_path": f"smile_data_n{N}_scale2_rot60_trans_50_-20/train.npy",
