...
WANDB_NAME=f"1210_lr1e4_n32_b{BATCH_SIZE}_T100_ddim_30_50_steps_no_init_rkdW{W_RKD}_invW{W_INV}_invinvW{W_INVINV}_fidW{W_FID}_sameW{W_SAME}_x0_pred_rkd_with_teacher_x0_inv_only_x0_no_norm"
...
CONFIG = {
    ...
    # wandb
    "use_wandb": True,
    "wandb_project": "RKD-DKDM-AICA-1209-NO-NORM",
