...
WANDB_NAME=f"1118_lr1e4_n32_b{BATCH_SIZE}_ddim_50_150_steps_no_init_rkdW{W_RKD}_invW{W_INV}_invinvW{W_INVINV}_fidW{W_FID}_x0prediction_no_denorm"
...
CONFIG = {
    ...
    # wandb
    "use_wandb": True,
    "wandb_project": "RKD-DKDM-AICA-1118",
...
def sample_ddim_student(
    ...
    for i, t in enumerate(local.timesteps):
        ...
        xs.append(out.pred_original_sample) 
